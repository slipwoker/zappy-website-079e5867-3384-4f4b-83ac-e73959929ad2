document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('blur', function(e) {
            ...
            if (required && !value) {
                showError(input, 'هذا الحقل مطلوب');
            } else if (value && type === 'email' && !validateEmail(value)) {
                showError(input, 'يرجى إدخال بريد إلكتروني صحيح');
            } else if (value && type === 'tel' && !validatePhone(value)) {
                showError(input, 'يرجى إدخال رقم هاتف صحيح');
            } else {
                clearError(input);
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '079e5867-3384-4f4b-83ac-e73959929ad2',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '079e5867-3384-4f4b-83ac-e73959929ad2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '079e5867-3384-4f4b-83ac-e73959929ad2';
